...
namespace gamer.Controllers
{
    ...
    public class EquipeController : Controller
    {
        ...
        //instância do contexto para acessar o banco
        Context c = new Context();

        //Rota para Listar as equipes
        [Route("Listar")]
        public IActionResult Index()
        {
            ViewBag.UserName = HttpContext.Session.GetString("UserName");
            //variável que armazenará as equipes listadas e levará para a view            
            ViewBag.Equipe = c.Equipe.ToList();

            //retorna a view (Index.cshtml da view de Equipe)
            return View();
        }
